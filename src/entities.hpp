...
struct SnakeSegment_t : ECS::Class_t<BasicCharacter_t, c::SnakeSegment_t, move_tag_t>
{};

struct SnakeTail_t : ECS::Class_t<BasicCharacter_t, SnakeSegment_t, move_tag_t>
{};

struct SnakeHead_t : ECS::Class_t<LivingCharacter_t, move_tag_t>
{};
